let fabOpen = false;
  ...
  const translations = {
    ...
    en: {
      ...
      sectionSkill: 'Skills',
      summary: 'A dedicated professional educator with a Bachelor\'s degree in Madrasah Ibtidaiyah Teacher Education (GPA 3.91, Cum Laude) and a Master\'s degree in Islamic Education Management from UIN Mataram (GPA 3.92, Cum Laude). Currently serving as a classroom teacher at SDN Abata Lombok, with prior experience as a private tutor. Highly committed to creating a conducive, innovative, and engaging learning environment. Strong communicator, collaborative team player, and driven to continuously grow within the field of education.',
      job1Company: 'SDN Abata Lombok',
