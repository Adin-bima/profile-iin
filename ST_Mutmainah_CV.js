let fabOpen = false;
  ...
  const translations = {
    ...
    en: {
      ...
      sectionSkill: 'Skills',
      summary: 'A dedicated professional educator with a Bachelor\'s degree in Madrasah Ibtidaiyah Teacher Education (GPA 3.91, Cum Laude), currently pursuing a Master\'s degree in Islamic Education Management at Universitas Muhammadiyah Mataram. Experienced in classroom teaching at SDN Abata Lombok and coaching students for Social Studies (IPS) olympiad preparation. Highly committed to creating a conducive, innovative, and engaging learning environment. Strong communicator, collaborative team player, and driven to continuously grow within the field of education.',
      job1Company: 'SDN Abata Lombok',
