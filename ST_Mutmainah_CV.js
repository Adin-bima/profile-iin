let fabOpen = false;
  ...
  const translations = {
    id: {
      ...
      summary: 'Seorang tenaga pendidik profesional dengan latar belakang S1 Pendidikan Guru Madrasah Ibtidaiyah (IPK 3.91, Cum Laude) dan saat ini sedang menempuh studi S2 Manajemen Pendidikan Islam di Universitas Muhammadiyah Mataram. Memiliki pengalaman mengajar langsung di SDN Abata Lombok serta memberikan bimbingan belajar privat kepada siswa secara individual. Berdedikasi tinggi dalam menciptakan lingkungan belajar yang kondusif, inovatif, dan menyenangkan. Mampu berkomunikasi dengan baik, bekerja secara kolaboratif, serta berkomitmen untuk terus berkembang dalam dunia pendidikan.',
      ...
      job2Period: '2024 – Sekarang',
      job2Role: 'Pengajar Paruh Waktu',
      job2Duties: [
      ...
      edu: [
        { school: 'Universitas Muhammadiyah Mataram', detail: 'S2 Manajemen Pendidikan Islam', year: '2024–2026 · IPK 3.92 (Cum Laude)' },
    ...
    en: {
      ...
      sectionSkill: 'Skills',
      summary: 'A dedicated professional educator with a Bachelor\'s degree in Madrasah Ibtidaiyah Teacher Education (GPA 3.91, Cum Laude), currently pursuing a Master\'s degree in Islamic Education Management at Universitas Muhammadiyah Mataram. Experienced in classroom teaching at SDN Abata Lombok and providing one-on-one private tutoring. Highly committed to creating a conducive, innovative, and engaging learning environment. Strong communicator, collaborative team player, and driven to continuously grow within the field of education.',
      job1Company: 'SDN Abata Lombok',
      ...
      job2Period: '2024 – Present',
      job2Role: 'Part-Time Tutor',
      job2Duties: [
      ...
      edu: [
        { school: 'Universitas Muhammadiyah Mataram', detail: 'Master\'s – Islamic Education Management', year: '2024–2026 · GPA 3.92 (Cum Laude)' },
