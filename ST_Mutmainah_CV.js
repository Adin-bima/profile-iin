let fabOpen = false;
  ...
  const translations = {
    id: {
      ...
      edu: [
        { school: 'Universitas Muhammadiyah Mataram', detail: 'S2 Manajemen Pendidikan Islam', year: '2024–2025 · IPK 3.92 (Cum Laude)' },
    ...
    en: {
      ...
      sectionSkill: 'Skills',
      summary: 'A dedicated professional educator with a Bachelor\'s degree in Madrasah Ibtidaiyah Teacher Education (GPA 3.91, Cum Laude) and a Master\'s degree in Islamic Education Management from Universitas Muhammadiyah Mataram (GPA 3.92, Cum Laude). Experienced in classroom teaching at SDN Abata Lombok and coaching students for Social Studies (IPS) olympiad preparation. Highly committed to creating a conducive, innovative, and engaging learning environment. Strong communicator, collaborative team player, and driven to continuously grow within the field of education.',
      job1Company: 'SDN Abata Lombok',
      ...
      edu: [
        { school: 'Universitas Muhammadiyah Mataram', detail: 'Master\'s – Islamic Education Management', year: '2024–2025 · GPA 3.92 (Cum Laude)' },
